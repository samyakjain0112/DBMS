...
-- INSERT INTO `dbmscourse`.`TreatmentAndFacilities` (`cost`, `timeRequired`, `name`, `treatmentId`, `staffId`) VALUES ('250', '1', 'Hair-cut', '1001', '4');
-- INSERT INTO `dbmscourse`.`StaffMember` (`name`, `staffId`, `salary`, `address`, `workingHours`, `contact`, `loginId`) VALUES ('Sapna', '1', '4000', 'Indore', '10', '9755097923', '102');
...
contact CHAR(10) NOT NULL,
 loginId INT NOT NULL,
  ...
  FOREIGN KEY (loginId) REFERENCES LoginAccount(loginId) ON DELETE CASCADE 
);
...
(
  ...
  PRIMARY KEY (productId),
  FOREIGN KEY (clientId) REFERENCES Client(clientId) ON DELETE CASCADE ,
  FOREIGN KEY (distributerId) REFERENCES Distributer(distributerId) ON DELETE CASCADE ,
...
(
  ...
  FOREIGN KEY (customerId) REFERENCES Customer(customerId) ON DELETE CASCADE ,
  FOREIGN KEY (clientId) REFERENCES Client(clientId) ON DELETE CASCADE ,
  FOREIGN KEY (treatmentId) REFERENCES TreatmentAndFacilities(treatmentId) ON DELETE CASCADE 
);
