...
<div class="form1">				
<form action="/client/deletestaffmembercall"  >
<h3>Delete a Staff Member</h3>
<select id="loginId" name="loginId" required="required">
<option value="">Choose the staffmember to delete</option>
	    <c:forEach var="staffmember" items="${getallstaffmembers}">
	       <option value="${staffmember.getLoginId()}">${staffmember.getName()} ${staffmember.getStaffId()}</option>   
	   </c:forEach>
	   </select>
