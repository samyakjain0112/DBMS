...
<body>
	...
	<form-title><center><h2>Customer</h2></center></form-title>
		...
		<div class="dropdown-list-element">
			...
			<ul class="dropdown-list-items">
			   <li><a href="/customer/profile/${loggedInUsername}">${loggedInUsername} Profile</a></li>
			...
			<div class="dropdown-title-container not-border" onclick="toggleBox(this)">
    			<div class="arrow"></div>
    			<div class="title-text">Appointment</div>
  			</div>
			<div class="content">
			<ul class="dropdown-list-items">
			 <li><a href="/customer/appointment">Book an Appointment</a></li>
            
       
              <li><a href="/customer/viewappointment">Your Appointments</a></li>
			...
			<div class="dropdown-title-container not-border" onclick="toggleBox(this)">
    			<div class="arrow"></div>
    			<div class="title-text">Payments and Purchases</div>
  			</div>
			<div class="content">
			<ul class="dropdown-list-items">
			   <li><a href="/customer/payment">Buy Products and Cosmetics</a></li>
  
              <li><a href="/customer/viewpastpurchases">Past Purchases</a></li>
			...
			<div class="dropdown-title-container not-border" onclick="toggleBox(this)">
    			<div class="arrow"></div>
    			<div class="title-text">Give Feedback</div>
  			</div>
			<div class="content">
			<ul class="dropdown-list-items">
			        <li><a href="/customer/feedback">Give Feedback</a></li>
