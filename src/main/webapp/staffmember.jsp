...
<body>
	...
	<form-title><center><h2>Staff</h2></center></form-title>
		...
		<div class="dropdown-list-element">
			...
			<li><a href="/staffmember/profile/${loggedInUsername}">${loggedInUsername} Profile</a></li>
		...
		<div class="dropdown-list-element">
			<div class="dropdown-title-container not-border" onclick="toggleBox(this)">
    			<div class="arrow"></div>
    			<div class="title-text">My Appointments</div>
  			</div>
			<div class="content">
			<ul class="dropdown-list-items">
			   
     <li><a href="/staffmember/viewappointment">Today's Appointments</a></
		...
		<div class="dropdown-list-element">
			<div class="dropdown-title-container not-border" onclick="toggleBox(this)">
    			<div class="arrow"></div>
    			<div class="title-text">See FeedBacks</div>
  			</div>
			<div class="content">
			<ul class="dropdown-list-items">
			        <li><a href="/staffmember/viewfeedback">View Feedbacks</a></li>
			</ul>
			</div>
		</div>
...
<!--  Welcome Staff Member
    ...
    <li><a href="/staffmember/profile/${loggedInUsername}">${loggedInUsername} Profile</a></li>
              StaffMember can view all his profile and return also
              Return page
              
     <li><a href="/staffmember/viewappointment">Today's Appointments</a></li>
              StaffMember can see todays appointments without customer  details
              Return page
     <li><a href="/staffmember/viewfeedback">Feedback</a></li>
              StaffMember can see all feedbacks 
