...
<br>
<h3>StaffId: ${staffMemberDetails.staffId}</h3>
<br>
<h3>Name:${staffMemberDetails.name}</h3>
<br>
<h3>Contact: ${staffMemberDetails.contact}</h3>
<br>
<h3>LoginId: ${staffMemberDetails.loginId}</h3>
<br>
<h3>Address: ${staffMemberDetails.address}</h3>
<br>
<h3>Salary: ${staffMemberDetails.salary}</h3>
<br>
<h3> Working Hours:${staffMemberDetails.workingHours}</h3>
<br>
</div>
