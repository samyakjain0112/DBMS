...
<h3>CustomerId: ${customerDetails.customerId}<br></h3>
<br>
<h3>Name: ${customerDetails.name}<br></h3>	
<br>
<h3>Contact: ${customerDetails.contact}<br></h3>
<br>
<h3>LoginId: ${customerDetails.loginId}<br></h3>
<br>
<h3>Address: ${customerDetails.address}<br></h3>
<br>
<h3>Date of Birth: ${customerDetails.dob}<br></h3>
<br>
</div>
