...
<body>
	...
	<form-title><center><h2>Distributer</h2></center></form-title>
		...
		<div class="dropdown-list-element">
			...
			<ul class="dropdown-list-items">
			    <li><a href="/distributer/profile/${loggedInUsername}">${loggedInUsername} Profile</a></li>
			...
			<div class="dropdown-title-container not-border" onclick="toggleBox(this)">
    			<div class="arrow"></div>
    			<div class="title-text">Client Requirements</div>
  			</div>
			<div class="content">
			<ul class="dropdown-list-items">
			    <li><a href="distributer/seeproductrequired">Products Required</a></li>
		...
		<!--  		
              ...
              <li><a href="/distributer/profile/${loggedInUsername}">${loggedInUsername} Profile</a></li>
              Distributer can view all his profile and return also
              Return page

              <li><a href="distributer/seeproductrequired">Products Required</a></li>
              Distributer can see the products required by the client and provide them offline
            -->
