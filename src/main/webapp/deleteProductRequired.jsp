...
<div class="form1">				
<form action="/client/deleteproductrequiredcall"  >
<h3>Delete a Product Required</h3>
<select id="productId" name="productId" required="required">
<option value="">Choose the Product required form distributer to delete</option>
	    <c:forEach var="product" items="${getallproducts}">
	       <option value="${product.getProductId()}">${product.getProductId()} ${product.getQuantity()}</option>   
	   </c:forEach>
	   </select>
