...
<body>
 ...
 <div id="wrapper1">				
<h1>Customer ${loggedInUsername}</h1>

<h3>Customer's Past Purchases</h3>
<br>
...
<c:forEach var="payment" items="${getallpastpayments}">
<tr>
...
<h3>Customer's Past Appointments</h3>
<br>
...
<c:forEach var="appointment" items="${getallappointmentscustomerpast}">
