...
<div class="form1">
<form action="/client/deleteproductcall">
<h3>Delete a Product</h3>
<select id="productId" name="productId" required="required">
<option value="">Choose the Product to delete</option>
	    <c:forEach var="productS" items="${getallproducts}">
	       <option value="${productS.getProductId()}">${productS.getProductId()} ${productS.getCompanyName()} ${productS.getMrp()}</option>   
	   </c:forEach>
	   </select>
