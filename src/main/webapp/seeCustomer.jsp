...
<br>
<br>
<form action="/client/seecustomerbyname" >

<label for ="name">Search Customers </label>
...
<c:forEach var="customersearch" items="${getcustomersbyname}">

<tr>

		  <td><a href="/client/customeralldetails/${customersearch.customerId}">${customersearch.customerId}</a></td>
		  <td>${customersearch.name}</td>
	      <td> ${customersearch.contact}</td>
	      <td> ${customersearch.loginId}</td>
	      <td> ${customersearch.address}</td>
	      <td> ${customersearch.dob}</td>
	      </tr> 
	   </c:forEach>
            </table>      
<br>
...
<br>        
<div id="wrapper">
<h3>The table below shows all the registered customers </h3>
<br>
<table class="table table-bordered">
<tr>
<th> Customer Id</th>
...
<c:forEach var="customer" items="${getallcustomers}">

<tr>

		  <td><a href="/client/customeralldetails/${customer.customerId}">${customer.customerId}</a></td>
	      <td> ${customer.name}</td>
