...
<div class="form1">
<form action="/client/deletedistributercall"  >
<h3> Delete a Distributer</h3>
<select id="loginId" name="loginId" required="required">
<option value="">Choose the distributer to delete</option>
	    <c:forEach var="distributer" items="${getalldistributers}">
	       <option value="${distributer.getLoginId()}">${distributer.getName()} ${distributer.getDistributerId()}</option>   
	   </c:forEach>
	   </select>
