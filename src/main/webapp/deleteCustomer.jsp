...
<div class="form1">				
<form action="/client/deletecustomercall"  >
<h3>Delete a Customer</h3>
<select id="loginId" name="loginId" required="required">
<option value="">Choose the customer to delete</option>
	    <c:forEach var="customer" items="${getallcustomers}">
	       <option value="${customer.getLoginId()}">${customer.getName()} ${customer.getCustomerId()}</option>   
	   </c:forEach>
	   </select>
