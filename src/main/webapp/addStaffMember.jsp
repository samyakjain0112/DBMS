...
<div class="form1">
<form action="/client/addstaffmembercall"  >
<h3>Add a Staff Member</h3>
<label for ="loginId">Staff LoginId</label>
...
<input type="text" id="contact" name="contact" required="required"><br>
...
<input type="text" id= "workingHours" name= "workingHours" required="required"><br>
