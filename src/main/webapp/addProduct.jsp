...
<div class="login-page1">
 <div class="form1">
<form action="/client/addproductcall">
<h3>Add a Product</h3>
<label for ="productId">Product Id</label>
<input type="number" id= "productId" name= "productId"  required="required"><br>

<label for ="mrp">Maximum Retail Price</label>
<input type="number" id= "mrp" name= "mrp" required="required"><br>

<label for ="discount">Discount</label>
<input type="number" id="discount" name="discount" required="required"><br>

<label for ="expiryDate">Expiry Date</label>
<input type="date" id="expiryDate" name="expiryDate" required="required"><br>


<label for ="companyName">Company Name</label>
<input type="text" id="companyName" name="companyName" required="required"><br>

<label for ="distributerId">Distributer Id</label>
<input type="number" id="distributerId" name= "distributerId" required="required"><br>
