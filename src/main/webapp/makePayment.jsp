...
<div class="form1">
<form action="/customer/paymentcall" >
<h3> Payment Details</h3>
<label for ="transactionId">Transaction Id</label>
<input type="number" id= "transactionId" name= "transactionId" required="required"><br>
...
<option value="">Product</option>
	    <c:forEach var="product" items="${getallproducts}">
	       <option value="${product.getProductId()}">${product.getProductId()} ${product.getCompanyName()} ${product.getMrp()}</option>   
	   </c:forEach>
	   </select>
