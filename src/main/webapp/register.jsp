...
<label for ="loginId">UserId</label>
<input type="number" id="loginId" name= "loginId" required="required"><br>

<label for ="password">Password</label>
<input type="password" id ="password" name="password" maxlength="20" minlength="0" required="required"><br>

<label for ="contact">Contact</label>
<input type="number" id="contact" name="contact" min="1000000000" max="9999999999" required="required"><br>
